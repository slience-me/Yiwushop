  ...
  <page-header-wrapper>
    <a-card :bordered="false">
      <div class="table-page-search-wrapper">
        <a-form layout="inline">
          <a-row :gutter="48">
            <a-col :md="6" :sm="24">
              <a-form-item label="">
                <a-input v-model="queryParam.keyword" placeholder="角色名称/角色描述" allowClear/>
              </a-form-item>
            </a-col>
      ...
      <div class="table-operator">
        <a-button v-action:add type="primary" icon="plus" @click="handleAction(0, null)">新建角色</a-button>
      </div>
      <a-alert show-icon style="margin-bottom: 16px">
        <template slot="message">
          ...
          <a style="margin-right: 20px" @click="del(0, null)">删除</a>
      ...
      <s-table
        ...
        <span slot="action" slot-scope="text, record">
          <template>
            ...
            <a v-action:del style="margin-left: 10px" @click="del(1, record)">删除</a>
          </template>
        </span>
      </s-table>
      <a-modal
        ...
        <a-form-model
          ...
          <a-form-model-item :labelAlign="'right'" label="角色描述：" prop="roleDesc">
            <a-input v-model="roleForm.roleDesc" allowClear placeholder="请输入角色描述" style="width: 100%" />
          </a-form-model-item>
...
import { getRoleList, delRole, getMenu, addRole, editRole } from '@/api/manage'
    ...
    return {
      ...
      roleRules: {
        ...
        roleDesc: [
          ...
          { min: 0, max: 50, message: '角色描述长度为0-50位' }
        ],
        menuIds: [
