    ...
    <a-card :bordered="false">
      <s-table
        ...
        <span slot="action" slot-scope="text, record">
          <template>
            <a v-action:state style="margin-left: 10px" @click="handleState(record)">上架</a>
...
import { delGoods, getGoodsNoList } from '@/api/shop'
    ...
    data () {
      ...
      return {
        ...
        loadData: parameter => {
          ...
          return getGoodsNoList(requestParameters)
            .then(res => {
              return res.data
            })
        },
